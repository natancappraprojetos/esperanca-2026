...
export default function LeadFormStep({ campaign, onSubmit, data }: LeadFormStepProps) {
  ...
  return (
    <div className="min-h-svh flex flex-col items-center justify-center w-full px-8 md:px-12 py-10 sm:py-16">
      <div className="w-full max-w-[420px] mx-auto mb-6">
        <div 
          className="flex flex-col gap-6 md:gap-8 bg-white/60 backdrop-blur-2xl border border-gray-100/50 p-8 sm:p-10 rounded-[32px] shadow-2xl w-full"
        >
          {/* Header */}
